...
export default function StatsGiocatori(props) {
	...
	const fetchUsers = async page => {
		setLoading(true);
        const res = await fetch('http://127.0.0.1:8000/api/v2/player-stats-data/?page=' + page + '&per_page=' + perPage)
	...
	const handlePerRowsChange = async (newPerPage, page) => {
        ...
        const res = await fetch('http://127.0.0.1:8000/api/v2/player-stats-data/?page' + page + '&per_page=' + newPerPage)
        const data = await res.json()
    ...
    const handleRole = async(role) => {
        ...
        const res = await fetch('http://127.0.0.1:8000/api/v2/player-stats-data/' + queryFilter)
